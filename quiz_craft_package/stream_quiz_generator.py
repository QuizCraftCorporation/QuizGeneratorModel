...
class StreamQuizGenerator():

    def __init__(self, file_paths: list[str], q_fraction: list[float] = [0.7, 0.2, 0.1], debug=False, delay: float = 10) -> None:
        """
    ...
    def __iter__(self):
        for file_path in self.file_paths:
            ...
            text = FileReader(file_path).get_content()
